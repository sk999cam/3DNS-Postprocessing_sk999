function [up,dn] = multiblock(blk,next_block,next_patch,nbnow,pitch,ng)
%ng=1;
up.xi = 0;
up.yi = 0;
dn.xi = 0;
...
if(im_next_block~=0)
    ...
    if(im_next_patch==1)
        ...
        if( (blk{ib}.y(1,1) - blk{im_next_block}.y(1,1)) < -0.1*pitch ); yoffset =-pitch; end
        xup = blk{im_next_block}.x(1:ng,:);
        yup = blk{im_next_block}.y(1:ng,:)+yoffset;
    end
    ...
    if(im_next_patch==2)
        ...
        if( (blk{ib}.y(1,1) - blk{im_next_block}.y(end,1)) < -0.1*pitch ); yoffset =-pitch; end
        xup = blk{im_next_block}.x(end:-1:end-ng+1,:);
        yup = blk{im_next_block}.y(end:-1:end-ng+1,:)+yoffset;
    end
...
if(ip_next_block~=0)
    ...
    if(ip_next_patch==1)
        ...
        if( (blk{ib}.y(end,1) - blk{ip_next_block}.y(1,1)) < -0.1*pitch ); yoffset =-pitch; end
        xdn = blk{ip_next_block}.x(1:ng,:);
        ydn = blk{ip_next_block}.y(1:ng,:)+yoffset;
    end
    ...
    if(ip_next_patch==2)
        ...
        if( (blk{ib}.y(end,1) - blk{ip_next_block}.y(end,1)) < -0.1*pitch ); yoffset =-pitch; end
        xdn = blk{ip_next_block}.x(end:-1:end-ng+1,:);
        ydn = blk{ip_next_block}.y(end:-1:end-ng+1,:)+yoffset;
    end
...
if(jm_next_block~=0)
    ...
    if(jm_next_patch==1)
        ...
        if( (blk{ib}.y(1,1)' - blk{jm_next_block}.y(1,1)) < -0.1*pitch ); yoffset =-pitch; end
        xup = blk{jm_next_block}.x(1:ng,:)';
        yup = blk{jm_next_block}.y(1:ng,:)'+yoffset;
    end
    ...
    if(jm_next_patch==2)
        ...
        if( (blk{ib}.y(1,1)' - blk{jm_next_block}.y(end,1)) < -0.1*pitch ); yoffset =-pitch; end
        xup = blk{jm_next_block}.x(end:-1:end-ng+1,:)';
        yup = blk{jm_next_block}.y(end:-1:end-ng+1,:)'+yoffset;
    end
...
if(jp_next_block~=0)
    ...
    if(jp_next_patch==1)
        ...
        if( (blk{ib}.y(1,end)' - blk{jp_next_block}.y(1,1)) < -0.1*pitch ); yoffset =-pitch; end
        xdn = blk{jp_next_block}.x(1:ng,:)';
        ydn = blk{jp_next_block}.y(1:ng,:)'+yoffset;
    end

    if(jp_next_patch==2)
        yoffset = 0.0;
        if( (blk{ib}.y(1,end)' - blk{jp_next_block}.y(end,:)) >  0.1*pitch ); yoffset = pitch; end
        if( (blk{ib}.y(1,end)' - blk{jp_next_block}.y(end,:)) < -0.1*pitch ); yoffset =-pitch; end
        xdn = blk{jp_next_block}.x(end:-1:end-ng+1,:)';
        ydn = blk{jp_next_block}.y(end:-1:end-ng+1,:)'+yoffset;
    end
